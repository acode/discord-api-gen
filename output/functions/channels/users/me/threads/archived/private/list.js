 ...
 * Returns archived threads in the channel that are of [type](https://discord.com/developers/docs/resources/channel#channel-object-channel-types) `PRIVATE_THREAD`, and the user has joined
 ...
 * @returns {object}
 */
module.exports = (channel_id, before = null, limit = null) => {

  const supportsMultipart = false;
  const _method = 'GET';
  let _pathname = '/channels/{channel_id}/users/@me/threads/archived/private';
