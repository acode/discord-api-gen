 ...
 * @returns {object}
 */
module.exports = (channel_id, webhook_channel_id) => {

  const supportsMultipart = false;
  const _method = 'POST';
  let _pathname = '/channels/{channel_id}/followers';
  ...
  const _bodyParams = {};
  if (webhook_channel_id !== null) { _bodyParams['webhook_channel_id'] = webhook_channel_id; }
