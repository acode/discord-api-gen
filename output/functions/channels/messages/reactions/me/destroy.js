 ...
 * @returns {object}
 */
module.exports = (channel_id, message_id, emoji) => {

  const supportsMultipart = false;
  const _method = 'DELETE';
  let _pathname = '/channels/{channel_id}/messages/{message_id}/reactions/{emoji}/@me';
  ...
  if (emoji !== null) { _pathParams['emoji'] = emoji; }
