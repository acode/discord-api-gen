...
/**
 * Create Webhook
 * Creates a new webhook and returns a [webhook](https://discord.com/developers/docs/resources/webhook#webhook-object) object on success
...
module.exports = (channel_id) => {
  ...
  const _method = 'POST';
  let _pathname = '/channels/{channel_id}/webhooks';
