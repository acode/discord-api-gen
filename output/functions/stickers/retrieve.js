...
/**
 * Get Sticker
 * Returns a [sticker](https://discord.com/developers/docs/resources/sticker#sticker-object) object for the given sticker ID.
 * @param {string} sticker_id [id of the sticker](https://discord.com/developers/docs/reference#image-formatting)
 * @returns {object}
 */
module.exports = (sticker_id) => {

  const supportsMultipart = false;
  const _method = 'GET';
  let _pathname = '/stickers/{sticker_id}';
