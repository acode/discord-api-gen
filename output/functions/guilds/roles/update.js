 ...
 * @returns {object}
 */
module.exports = (guild_id, role_id, name, permissions, color, hoist, icon, unicode_emoji, mentionable) => {

  const supportsMultipart = false;
  const _method = 'PATCH';
  let _pathname = '/guilds/{guild_id}/roles/{role_id}';
  ...
  if (role_id !== null) { _pathParams['role_id'] = role_id; }
