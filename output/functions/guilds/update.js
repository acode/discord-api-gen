 ...
 * @returns {object}
 */
module.exports = (guild_id, name, region, verification_level, default_message_notifications, explicit_content_filter, afk_channel_id, afk_timeout, icon, owner_id, splash, discovery_splash, banner, system_channel_id, system_channel_flags, rules_channel_id, public_updates_channel_id, preferred_locale, features, description, premium_progress_bar_enabled, safety_alerts_channel_id) => {
