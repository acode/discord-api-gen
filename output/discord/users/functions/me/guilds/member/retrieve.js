 ...
 * Returns a [guild member](https://discord.com/developers/docs/resources/guild#guild-member-object) object for the current user
...
module.exports = async (guild_id, context) => {
  ...
  const _method = 'GET';
  let _pathname = '/users/@me/guilds/{guild_id}/member';
