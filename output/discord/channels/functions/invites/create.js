 ...
 * @param {integer} max_age Duration of invite in seconds before expiry, or 0 for never
 * between 0 and 604800 (7 days)
 * @param {integer} max_uses Max number of uses or 0 for unlimited
 * between 0 and 100
 ...
 * @returns {object}
 */
module.exports = async (channel_id, max_age, max_uses, temporary, unique, target_type, target_user_id, target_application_id, context) => {
