 ...
 * @param {string} nonce Can be used to verify a message was sent (up to 25 characters)
 ...
 * @ {object} action_row 
 * @param {array} sticker_ids IDs of up to 3 [stickers](https://discord.com/developers/docs/resources/sticker#sticker-object) in the server to send in the message
 * @ {string}  
 ...
 * @returns {object}
 */
module.exports = async (channel_id, content = null, nonce = null, tts = null, embeds = null, allowed_mentions = null, message_reference = null, components = null, sticker_ids = null, attachments = null, flags = null, context) => {
