 ...
 * Returns a list of [integration](https://discord.com/developers/docs/resources/guild#integration-object) objects for the guild
...
module.exports = async (guild_id, context) => {
  ...
  const _method = 'GET';
  let _pathname = '/guilds/{guild_id}/integrations';
