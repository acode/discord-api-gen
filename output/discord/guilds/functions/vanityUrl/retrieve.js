 ...
 * Returns a partial [invite](https://discord.com/developers/docs/resources/invite#invite-object) object for guilds with that feature enabled
...
module.exports = async (guild_id, context) => {
  ...
  const _method = 'GET';
  let _pathname = '/guilds/{guild_id}/vanity-url';
