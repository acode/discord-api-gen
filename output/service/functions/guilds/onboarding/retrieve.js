 ...
 * Returns the [Onboarding](https://discord.com/developers/docs/resources/guild#guild-onboarding-object) object for the guild.
...
module.exports = async (guild_id) => {
  ...
  const _method = 'GET';
  let _pathname = '/guilds/{guild_id}/onboarding';
